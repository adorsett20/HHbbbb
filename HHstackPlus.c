...
//Print out total events in MC background
  ...
  cout << "	 ttbar: " << httbar->Integral() << endl;
  cout << "	   qcd: " << hqcd->Integral() << endl;
  cout << "	ZWjets: " << hwjets->Integral()+hznn->Integral() << endl;
  cout << "	 Other: " << hother->Integral() << endl;
//  cout << endl << "efficiency factor = " << (hdata->Integral()/75)/sqrt(hmc->Integral()/203034) << endl;
