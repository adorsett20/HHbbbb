...
TColor ucsb_blue_lite(2000, 0/255.,111/255.,195/255.);
TColor uscb_gold_lite(2001, 255/255.,200/255.,47/255);
TColor penn_red_lite(2002, 255/255.,0/255.,43/255.);
TColor carrot(2003, 230/255., 91/255., 20/255.);
TColor uo_green_lite(2004, 23/255.,160/255.,74/255.);
TColor tcu_purple_lite(2005, 125/255.,56/255.,173/255.);
TColor tiger(2006, 248/255., 84/255., 9/255.);
...
TColor c_acc(3000, 29/255., 102/255., 100/255.);
TColor c_reco(3001, 165/255., 175/255., 126/255.);
...
void set_avocado_palette()
{
  ...
  Double_t red[nRGBs]   = { 4./255., 12./255.,  30./255.,  52./255., 101./255., 142./255., 190./255., 237./255., 251./255.};
  Double_t green[nRGBs] = { 40./255., 86./255., 121./255., 140./255., 172./255., 187./255., 213./255., 240./255., 255./255.};
  Double_t blue[nRGBs]  = { 9./255., 14./255.,  18./255.,  21./255.,  23./255.,  27./255.,  35./255., 101./255., 93./255.};
  TColor::CreateGradientColorTable(nRGBs, stops, red, green, blue, NCont);
  gStyle->SetNumberContours(NCont);
}
...
void set_temperature_palette()
{
  ...
  const Int_t NCont = 255;
  Double_t stops[nRGBs] = { 0.0000, 0.1250, 0.2500, 0.3750, 0.475, 0.5, 0.525, 0.6250, 0.7500, 0.8750, 1.0000};
  Double_t red[nRGBs]   = {  30./255.,  55./255., 103./255., 147./255., 255./255., 255./255., 255./255., 203./255., 188./255., 151./255., 105./255.};
  Double_t green[nRGBs] = {   0./255.,  65./255., 138./255., 182./255., 255./255., 255./255., 255./255., 175./255., 121./255.,  53./255.,   9./255.};
  Double_t blue[nRGBs]  = { 191./255., 202./255., 212./255., 208./255., 255./255., 255./255., 255./255., 140./255.,  97./255.,  57./255.,  30./255.};
  TColor::CreateGradientColorTable(nRGBs, stops, red, green, blue, NCont);
  gStyle->SetNumberContours(NCont);
}
