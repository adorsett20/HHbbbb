...
//TChain setup
  ...
  ttbar->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_HT-2500toInf.root", skimdir.Data()));
  ttbar->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_HT-1200to2500.root", skimdir.Data()));
  ttbar->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_HT-600to800.root", skimdir.Data()));
  ttbar->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_HT-800to1200.root", skimdir.Data()));
  TChain* ttbar_lep = new TChain("tree");
  ttbar_lep->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_SingleLeptFromT.root", skimdir.Data()));
  ttbar_lep->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_SingleLeptFromTbar.root", skimdir.Data()));
  ttbar_lep->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets_DiLept.root", skimdir.Data()));
  TChain* ttbar_had = new TChain("tree");
  ttbar_had->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTJets.root", skimdir.Data()));
  TChain* qcd = new TChain("tree");
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-700to1000.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-200to300.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-300to500.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-500to700.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-2000toInf.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-1500to2000.root", skimdir.Data()));
  qcd->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_QCD_HT-1000to1500.root", skimdir.Data()));
  TChain* znn = new TChain("tree");
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-400to600.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-600to800.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-200to400.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-100to200.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-800to1200.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-1200to2500.root", skimdir.Data()));
  znn->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZJetsToNuNu_HT-2500toInf.root", skimdir.Data()));
  TChain* wjets = new TChain("tree");
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-1200to2500.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-2500toInf.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-400to600.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-800to1200.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-600to800.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-200to400.root", skimdir.Data()));
  wjets->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WJetsToLNu_HT-100to200.root", skimdir.Data()));
  TChain* other = new TChain("tree");
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WWTo2L2Nu.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTWJetsToLNu.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTZToLLNuNu.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTTT.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTZToQQ.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_TTWJetsToQQ.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZZZ.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WZZ.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WWZ.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ST_s-channel.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_DYJetsToLL_M-50_HT-200to400.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WZTo1L3Nu.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_DYJetsToLL_M-50_HT-600toInf.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_DYJetsToLL_M-50_HT-400to600.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_DYJetsToLL_M-50_HT-100to200.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WWTo1L1Nu2Q.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZZTo2L2Q.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_WZTo1L1Nu2Q.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ZZTo2Q2Nu.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ST_tW_top.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ST_tW_antitop.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ST_t-channel_antitop.root", skimdir.Data()));
  other->Add(Form("root://cmseos.fnal.gov//store/user/lpcsusyhad/SusyRA2Analysis2015/Skims/Run2ProductionV9/%s/tree_ST_t-channel_top.root", skimdir.Data()));
...
//Put in Cuts
  ...
  TCut htmht_trigger("TriggerPass[40]||TriggerPass[41]||TriggerPass[44]||TriggerPass[45]");
...
//Make Plots
  ...
  Plot("JetsAK8[0].M()",ZL+baseline+filters+dPhi+Bcheck+JetFix, htmht_trigger+bad_lumi_filter, "Weight*30000", AK8,
